(function(window, document, undefined)
{
	...
	var Banner = (function()
	{
		...
		function init()
		{
			...
			// box1
			box1 = new lib.box1();
			box1.setTransform(7,103,1,1,0,0,0,0,0);
			box1.alpha = 0;
			box1.scaleY = 0.1;

			txtPurpleBox = new createjs.Bitmap("txtPurpleBox.png");
			txtPurpleBox.x = -250;
			txtPurpleBox.y = 116;
			
			// box2
			box2 = new lib.box2();
			box2.setTransform(7,190,1,1,0,0,0,0,0);
			box2.alpha = 0;
			box2.scaleY = 0.1;

			txtOrangeBox = new createjs.Bitmap("txtOrangeBox.png");
			txtOrangeBox.x = -250;
			txtOrangeBox.y = 204;
			
			// logo
			logo = new createjs.Bitmap("logo.gif");
			logo.x = 100;
			logo.y = 70;
			logo.alpha = 0;
			stage.addChild(logo);
			...
			btn = new lib.btn();
			btn.alpha = 0;
			btn.setTransform(53.5,204,1,1,0,0,0,0,0);

			f1txt1_f2txt1_f3txt1 = new createjs.Bitmap("f1txt1_f2txt1_f3txt1.gif");
			f1txt1_f2txt1_f3txt1.x = 23;
			f1txt1_f2txt1_f3txt1.y = 70;
			f1txt1_f2txt1_f3txt1.alpha = 0;
			stage.addChild(f1txt1_f2txt1_f3txt1);

			f2txt2_f3txt3_f5txt3 = new createjs.Bitmap("f2txt2_f3txt3_f5txt3.gif");
			f2txt2_f3txt3_f5txt3.x = 13;
			f2txt2_f3txt3_f5txt3.y = 280;
			f2txt2_f3txt3_f5txt3.alpha = 0;
			stage.addChild(f2txt2_f3txt3_f5txt3);

			f3txt2 = new createjs.Bitmap("f3txt2.gif");
			f3txt2.x = 93;
			f3txt2.y = 243;
			f3txt2.alpha = 0;
			stage.addChild(f3txt2);

			f4txt1 = new createjs.Bitmap("f4txt1.gif");
			f4txt1.x = 59;
			f4txt1.y = 156;
			f4txt1.alpha = 0;
			stage.addChild(f4txt1);

			f5txt1 = new createjs.Bitmap("f5txt1.gif");
			f5txt1.x = 35;
			f5txt1.y = 139;
			f5txt1.alpha = 0;
			stage.addChild(f5txt1);

			f5txt2 = new createjs.Bitmap("f5txt2.gif");
			f5txt2.x = 8;
			f5txt2.y = 164;
			f5txt2.alpha = 0;
			stage.addChild(f5txt2);

			/*
			orange = new createjs.Bitmap("orangeBgBtn.gif");
			orange.x = 3;
			orange.y = 180;
			orange.alpha = 0;
			...
			*/
			...
			txtBtn = new createjs.Bitmap("txtBtn.png");
			txtBtn.x = 83;
			txtBtn.y = 217;
			txtBtn.alpha = 0;
			
			stage.addChild(box2, box1, txtPurpleBox, txtOrangeBox, btn, txtBtn);
			stage.update();
